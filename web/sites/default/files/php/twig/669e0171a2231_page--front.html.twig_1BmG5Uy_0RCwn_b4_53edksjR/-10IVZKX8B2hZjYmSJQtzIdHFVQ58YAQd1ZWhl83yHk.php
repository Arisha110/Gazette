...
";
        // line 331
        if ( !twig_test_empty(($context["node"] ?? null))) {
            // line 332
            echo "  ";
            // line 333
            echo "  ";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["node"] ?? null), "field_article_content", [], "any", false, false, true, 333));
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                // line 334
                echo "    <article>
      <h2>";
                // line 335
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "title", [], "any", false, false, true, 335), "value", [], "any", false, false, true, 335), 335, $this->source), "html", null, true);
                echo "</h2>
      <div>";
                // line 336
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "body", [], "any", false, false, true, 336), "value", [], "any", false, false, true, 336), 336, $this->source));
                echo "</div>
      ";
                // line 338
                echo "    </article>
                ...
                <div class=\"col-12 col-lg-9\">
                    ...
                    <div class=\"gazette-welcome-post\">
                        ...
                        <div class=\"gazette-post-tag\">
                            <a href=\"#\">";
        // line 353
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "field_tags", [], "any", false, false, true, 353), 353, $this->source), "html", null, true);
        echo "</a>
                        </div>
...
";
    ...
    {
        return array (  162 => 353,  148 => 341,  140 => 338,  136 => 336,  132 => 335,  129 => 334,  124 => 333,  122 => 332,  120 => 331,  117 => 329,  105 => 251,  101 => 239,  95 => 203,  70 => 182,  57 => 171,  46 => 162,  43 => 47,  39 => 42,);
    }
...
{# Check if the page contains a node (content) #}
{% if node is not empty %}
  {# Render each article/content separately #}
  {% for item in node.field_article_content %}
    <article>
      <h2>{{ item.title.value }}</h2>
      <div>{{ item.body.value|raw }}</div>
      {# Render other fields as needed, e.g., images, tags, etc. #}
    </article>
  {% endfor %}
{% endif %}
...
", "themes/custom/gazette/templates/page--front.html.twig", "C:\\xampp\\htdocs\\Task1\\web\\themes\\custom\\gazette\\templates\\page--front.html.twig");
    ...
    {
        static $tags = array("if" => 331, "for" => 333);
        static $filters = array("escape" => 171, "raw" => 336);
